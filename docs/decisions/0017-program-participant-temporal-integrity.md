...
- **Adding or removing a participant mid-term remains deferred**, as does a `program_events`-style audit trail for who changed a panel, and retrofitting the flag-based escape hatch onto the three policy-side correction functions.
